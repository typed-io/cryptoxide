...
mod tests {
    ...
    // Multi-block known-answer tests for SHA-256 to deal with different backends
    // optimisation (AVX2 consume 8 blocks, SSE4.1 4 blocks, etc)
    #[test]
    fn test_sha256_multiblock() {
        let msg: [u8; 1024] = core::array::from_fn(|i| ((i * 7 + 3) & 0xff) as u8);

        let expected: [(usize, [u8; 32]); 12] = [
            (
                64,
                [
                    0x39, 0xe3, 0xd7, 0xb6, 0xb5, 0xd0, 0x75, 0xd3, 0x7d, 0x05, 0x3a, 0xd8, 0x9b,
                    0x24, 0xb4, 0x1b, 0xef, 0x4f, 0x3c, 0x29, 0x76, 0x0c, 0x84, 0x44, 0x7c, 0xab,
                    0x3f, 0x3b, 0xe1, 0x88, 0x22, 0x41,
                ],
            ),
            (
                192,
                [
                    0xec, 0x67, 0x32, 0x21, 0x40, 0x91, 0xfa, 0x84, 0x55, 0xee, 0x22, 0x51, 0xfb,
                    0x75, 0x64, 0x75, 0xb0, 0x4e, 0xc6, 0x26, 0x10, 0xfb, 0xce, 0xaa, 0x64, 0x21,
                    0x8a, 0x11, 0xfa, 0xf5, 0x71, 0xcd,
                ],
            ),
            (
                256,
                [
                    0xd9, 0xc7, 0x6f, 0xa3, 0x49, 0x78, 0xcb, 0x96, 0x20, 0xda, 0xb8, 0xc3, 0xf4,
                    0x6b, 0xbe, 0x07, 0x5f, 0xdd, 0xc1, 0x45, 0xeb, 0x28, 0x2b, 0x39, 0x00, 0x91,
                    0x41, 0xf9, 0x8d, 0x0c, 0xfe, 0x82,
                ],
            ),
            (
                257,
                [
                    0xb6, 0x5c, 0x39, 0x0e, 0x44, 0x82, 0x12, 0x3a, 0xe8, 0x1c, 0x34, 0x62, 0xcd,
                    0x2c, 0xe5, 0xba, 0xc5, 0x5c, 0xd9, 0xdf, 0xde, 0x2f, 0xcf, 0x92, 0x95, 0xc7,
                    0xd3, 0x20, 0xee, 0x45, 0x3f, 0xc5,
                ],
            ),
            (
                320,
                [
                    0x75, 0x51, 0xf2, 0x11, 0x61, 0xf4, 0x9a, 0x55, 0x05, 0xac, 0x64, 0x2f, 0xa2,
                    0x98, 0x3e, 0x09, 0x13, 0x8a, 0x9d, 0xee, 0x81, 0xc6, 0xcd, 0x41, 0x33, 0xbc,
                    0xc9, 0x42, 0x2d, 0x32, 0x92, 0x27,
                ],
            ),
            (
                512,
                [
                    0xc9, 0xd8, 0xe3, 0x35, 0x2f, 0x9f, 0x79, 0x0d, 0x8b, 0x0b, 0xe1, 0x3c, 0xb1,
                    0xc1, 0x8e, 0xd7, 0x96, 0x30, 0x09, 0x88, 0x8b, 0xe0, 0x4a, 0xcc, 0x06, 0x5e,
                    0xe5, 0xef, 0xbd, 0x93, 0x40, 0x76,
                ],
            ),
            (
                513,
                [
                    0x99, 0x87, 0xb6, 0x60, 0x97, 0x89, 0xdf, 0x83, 0xb8, 0x95, 0x85, 0x03, 0x08,
                    0xb1, 0xe1, 0xa0, 0x4c, 0x31, 0xbd, 0x49, 0x6a, 0xcd, 0xc0, 0xac, 0x3a, 0x23,
                    0x1b, 0xa0, 0xf7, 0x07, 0x55, 0x14,
                ],
            ),
            (
                576,
                [
                    0x7a, 0x01, 0xa5, 0x00, 0x9c, 0x15, 0x36, 0xee, 0x6b, 0xe9, 0x10, 0x53, 0xe5,
                    0x03, 0xfd, 0xe8, 0x19, 0x6c, 0x84, 0x99, 0xea, 0x9a, 0x33, 0x15, 0x61, 0x9a,
                    0xd7, 0x66, 0x0f, 0x13, 0x15, 0x6c,
                ],
            ),
            (
                832,
                [
                    0x2c, 0x5a, 0xbe, 0xca, 0x85, 0x7f, 0x3d, 0xf0, 0x77, 0x97, 0x18, 0x14, 0x4f,
                    0x01, 0xe2, 0x09, 0x30, 0x3c, 0xf4, 0xa0, 0x6b, 0x94, 0x4f, 0x37, 0x0c, 0xb7,
                    0xdb, 0x4c, 0xbe, 0x78, 0x80, 0xb0,
                ],
            ),
            (
                960,
                [
                    0xbc, 0xd7, 0x0f, 0xa6, 0xa4, 0x06, 0x5e, 0x25, 0x44, 0xbb, 0xe2, 0x89, 0x34,
                    0xb7, 0x9f, 0x74, 0x4f, 0x7a, 0x10, 0x79, 0xfb, 0x3d, 0x1d, 0xd9, 0xd5, 0x4a,
                    0x18, 0x5f, 0x26, 0x0b, 0x80, 0x10,
                ],
            ),
            (
                1000,
                [
                    0x1e, 0x9b, 0xc3, 0x8c, 0xbf, 0x86, 0x0b, 0x9e, 0xc3, 0x19, 0x18, 0xb0, 0x65,
                    0xf9, 0xb5, 0x24, 0x76, 0xc5, 0x49, 0xa7, 0x82, 0xe0, 0xe7, 0x99, 0x0b, 0xed,
                    0x8c, 0xe3, 0x86, 0x8d, 0x23, 0x71,
                ],
            ),
            (
                1024,
                [
                    0xe9, 0x18, 0x3d, 0x9a, 0x79, 0xaa, 0xd8, 0xa0, 0x47, 0xb8, 0xe6, 0x79, 0x81,
                    0x21, 0x0d, 0x50, 0xb0, 0x1f, 0xc7, 0x5b, 0x1e, 0xdb, 0xa5, 0xbc, 0x32, 0xba,
                    0x3d, 0x3e, 0xc4, 0xd5, 0x05, 0x6d,
                ],
            ),
        ];

        for (len, output) in expected {
            let mut ctx = Context256::new();
            ctx.update_mut(&msg[0..len]);
            assert_eq!(ctx.finalize(), output, "sha256 of {} bytes", len);

            // the same input fed in irregular pieces must buffer up to the
            // same block boundaries
            let mut ctx = Context256::new();
            let mut rest = &msg[0..len];
            for piece in [1, 63, 64, 65, 127, 200, 511] {
                let piece = core::cmp::min(piece, rest.len());
                ctx.update_mut(&rest[0..piece]);
                rest = &rest[piece..];
            }
            ctx.update_mut(rest);
            assert_eq!(ctx.finalize(), output, "sha256 of {} bytes, chunked", len);
        }
    }

    // Multi-block (256 bytes, i.e. two pre-padding SHA-512 blocks) known-answer
    // test. Exercises the block-iteration loop and, on aarch64, the sha512
    // crypto-extension backend. Reference digests generated with `shasum`.
    #[test]
    fn test_sha512_multiblock() {
        ...
        let expected512 = [
            0xe4, 0x9c, 0x20, 0x8e, 0x41, 0x55, 0x6e, 0x85, 0x9d, 0x1a, 0x52, 0xd1, 0x47, 0x84,
            0xa0, 0x61, 0xc2, 0xd5, 0xae, 0x2c, 0x86, 0x90, 0xa5, 0x36, 0x0e, 0x9f, 0x93, 0x44,
            0xf6, 0x08, 0x61, 0xc1, 0x36, 0x2a, 0x9e, 0xc0, 0x5a, 0x9f, 0x08, 0xa4, 0x16, 0x7b,
            0x3d, 0xa4, 0x1b, 0xdd, 0x12, 0x2a, 0x38, 0x74, 0x13, 0xdd, 0x06, 0x97, 0x64, 0x70,
            0xe4, 0xbe, 0xff, 0x50, 0x53, 0xf2, 0xac, 0x71,
        ];
        assert_eq!(ctx512.finalize(), expected512);

        let mut ctx384 = Context384::new();
        ctx384.update_mut(&msg);
        let expected384 = [
            0x23, 0xf0, 0x63, 0x45, 0x52, 0xba, 0x15, 0x28, 0x9f, 0xa0, 0x2c, 0x8a, 0x37, 0xe3,
            0xa3, 0x91, 0xe7, 0x9e, 0x23, 0x0d, 0xca, 0x05, 0xdb, 0x03, 0xa7, 0x69, 0x66, 0x30,
            0xc5, 0xba, 0x3a, 0x33, 0x52, 0xd1, 0x62, 0x4f, 0x52, 0x83, 0x2e, 0x4d, 0x61, 0x83,
            0xc0, 0xeb, 0x70, 0x19, 0x8e, 0x9a,
        ];
        assert_eq!(ctx384.finalize(), expected384);
    }
